...
include 'database/db-archived-report.php';
$activePage = 'db-archived-report';
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="GET" action="archived-daily-report.php">
                                ...
                                <input type="hidden" name="academic_year" value="<?= isset($_GET['academic_year']) ? htmlspecialchars($_GET['academic_year']) : '' ?>">
                            ...
                            <form method="GET" action="archived-monthly-report.php">
                                <div class="form-row mb-3">
                                    <div class="col-md-3">
            ...
            if (!month || !grade || !section) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'GET';
                        form.action = 'archived-daily-report.php';
            ...
            if (!gradeMonthly || !sectionMonthly) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const form = document.createElement('form');
                        form.method = 'GET';
                        form.action = 'archived-monthly-report.php';
