          ...
          <div class="modal-body">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="editStudentName" name="student_name" placeholder="John Doe" required>
              </div>
              <div class="col-md-6">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="tel" name="parent_contact" class="form-control" id="editParentContact" placeholder="123-456-7890" required>
              </div>
              <div class="col-md-6">
                <label for="editParentEmail" class="form-label">Parent Email Address</label>
                <input type="email" name="parent_email" class="form-control" id="editParentEmail" placeholder="parent@example.com" required>
              </div>
            </div>
