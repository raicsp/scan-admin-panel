...
$classes = [];
$query = "SELECT class_id, grade_level, section FROM classes $gradeCondition WHERE class_id IN (16,17)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['promote_students'])) {
        ...
        $deleteQuery = "DELETE FROM student WHERE class_id IN (17)";
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <h5 class="card-title ms-3">Senior High School</h5>
